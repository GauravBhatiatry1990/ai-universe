        ...
        <div className="max-w-5xl mx-auto px-6 py-10">
          ...
          <div className="mt-6 flex flex-wrap gap-4 text-sm">
            <div className="flex items-center gap-2 bg-green-50 text-green-700 px-3 py-1.5 rounded-full border border-green-200">
              ...
              <span className="text-green-600">Moved up since yesterday</span>
            </div>
            <div className="flex items-center gap-2 bg-red-50 text-red-700 px-3 py-1.5 rounded-full border border-red-200">
              ...
              <span className="text-red-600">Moved down since yesterday</span>
            </div>
            <div className="flex items-center gap-2 bg-purple-50 text-purple-700 px-3 py-1.5 rounded-full border border-purple-200">
              <span className="font-bold">✨ NEW</span>
              <span className="text-purple-600">Entered top 50 in 24h</span>
            </div>
          </div>
        </div>
      </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="col-span-1 text-center">
                    <span className="text-xl font-black text-gray-300 group-hover:text-purple-500 transition-colors">
                      #{index + 1}
                    </span>
                  </div>
                  ...
                  <div className="col-span-5 flex items-center gap-4">
                    <div className="w-10 h-10 rounded-xl bg-white border border-gray-200 flex items-center justify-center p-1 shadow-sm shrink-0">
                      <ToolLogo slug={tool.slug} size={28} />
                    </div>
                    <div>
                      <Link 
                        href={`/agent/${tool.slug}`} 
                        className="font-bold text-gray-900 hover:text-purple-600 transition text-lg"
                      >
                        {tool.name}
                      </Link>
                      <p className="text-xs text-gray-400 font-medium">{tool.category}</p>
                    </div>
                  </div>
                  ...
                  <div className="col-span-3 flex justify-end">
                    {isUp ? (
                      <div className="flex items-center gap-1.5 bg-green-50 text-green-700 px-3 py-1.5 rounded-lg border border-green-100">
                        <span className="text-xs font-bold">▲ UP 2</span>
                        <span className="text-[10px] text-green-600/70">vs yesterday</span>
                      </div>
                    ) : isNew ? (
                      <div className="flex items-center gap-1.5 bg-purple-50 text-purple-700 px-3 py-1.5 rounded-lg border border-purple-100">
                        ...
                        <span className="text-[10px] text-purple-600/70">this week</span>
                      </div>
                    ) : (
                      <div className="flex items-center gap-1.5 bg-red-50 text-red-700 px-3 py-1.5 rounded-lg border border-red-100">
                        ...
                        <span className="text-[10px] text-red-600/70">vs yesterday</span>
                      </div>
                    )}
                  </div>
                </div>
